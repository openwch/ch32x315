 ...
 *I2C1_SCL[PA0(AF3)]\I2C1_SDA[PA1(AF3)].
...
void IIC_Init(u32 bound, u16 address)
{
    ...
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource0, GPIO_AF3);
    ...
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_Very_High;
    GPIO_Init( GPIOA, &GPIO_InitStructure );
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource1, GPIO_AF3);
