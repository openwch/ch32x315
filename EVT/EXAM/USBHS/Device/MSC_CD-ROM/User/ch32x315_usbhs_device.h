/********************************** (C) COPYRIGHT *******************************
 * File Name          : ch32x315_usbhs_device.h
 * Author             : WCH
 * Version            : V1.0.0
 * Date               : 2026/01/19
 * Description        : header file of ch32x315_usbhs_device.c
 *********************************************************************************
...
#ifndef __CH32X315_USBHS_DEVICE_H__
#define __CH32X315_USBHS_DEVICE_H__
