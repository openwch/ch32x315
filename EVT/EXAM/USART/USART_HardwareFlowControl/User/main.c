 ...
 *@Note
 ...
 USART1_Tx(PA11)\USART1_Rx(PA10)\USART1_CTS(PC6)\USART1_RTS(PC7)
...
void USART1_ReCFG(void)
{
    ...
    RCC_HB2PeriphClockCmd(RCC_HB2Periph_GPIOA | RCC_HB2Periph_GPIOC | RCC_HB2Periph_USART1 | RCC_HB2Periph_AFIO, ENABLE);
    ...
    GPIO_PinAFConfig(GPIOC,GPIO_PinSource7,GPIO_AF1);
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7; /* RTS-->C.7 */
    ...
    GPIO_Init(GPIOA, &GPIO_InitStructure);
    GPIO_PinAFConfig(GPIOC,GPIO_PinSource6,GPIO_AF1);
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6; /* CTS-->C.6 */
    GPIO_Init(GPIOC, &GPIO_InitStructure);
