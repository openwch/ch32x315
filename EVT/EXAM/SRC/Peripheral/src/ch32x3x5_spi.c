 ...
 * @param   SPIx - where x can be
 *            - 1, 2 , 3 in SPI mode.
 *          SPI_SPEED_MODE - specifies the SPI interrupt source to be
 *        enabled.
 *            SPI_HIGH_SPEED_DISABLE - SPI normal speed mode.
 *            SPI_HIGH_SPEED_MODE1 - SPI high speed mode1.
 *            SPI_HIGH_SPEED_MODE2 - SPI high speed mode2.
 *
 * @return  none
 */
void SPI_HighSpeedMode_Config(SPI_TypeDef *SPIx, uint8_t SPI_SPEED_MODE)
{
