...
*******************************************************************************/ 
#ifndef __CH32X3x5_GPIO_H
#define __CH32X3x5_GPIO_H
...
/* GPIO_USBPDRISE_Mode */
#define GPIO_USBPDRISE_Mode0               ((uint8_t)0x00)
#define GPIO_USBPDRISE_Mode1               ((uint8_t)0x02)
#define GPIO_USBPDRISE_Mode2               ((uint8_t)0x04)
#define GPIO_USBPDRISE_Mode3               ((uint8_t)0x06)
