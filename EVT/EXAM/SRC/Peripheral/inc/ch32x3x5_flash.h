...
*******************************************************************************/
#ifndef __CH32X3x5_FLASH_H
#define __CH32X3x5_FLASH_H
...
#define FLASH_WRProt_Sectors31to119    ((uint32_t)0x80000000) /* Write protection of page 31 to 119 */
...
/* Option_Bytes_RST_EN */
#define OB_RST_NoEN                    ((uint16_t)0x0008) /* Reset IO disable */
#define OB_RST_EN                      ((uint16_t)0x0000) /* Reset IO enable  */

/* Option_Bytes_Power_ON_Start_Mode */
#define OB_PowerON_Start_Mode_BOOT     ((uint16_t)0x0010)  /* Boot start after power on */
#define OB_PowerON_Start_Mode_USER     ((uint16_t)0x0000)  /* User start after power on */

/* Option_Bytes_USBHSDLEN */
#define OB_USBHSDL_EN                  ((uint16_t)0x0040)  /* Boot Enable USBHS Download */
#define OB_USBHSDL_NoEN                ((uint16_t)0x0000)  /* Boot Disable USBHS Download */
...
#define FLASH_FLAG_WRBSY               ((uint32_t)0x00000002)  /* FLASH write Busy flag */
#define FLASH_FLAG_WRPRTERR            ((uint32_t)0x00000010)  /* FLASH Write protected error flag */
#define FLASH_FLAG_EOP                 ((uint32_t)0x00000020)  /* FLASH End of Operation flag */
#define FLASH_FLAG_BOOT_LOADER         ((uint32_t)0x00000800)  /* BOOT load flag */
#define FLASH_FLAG_BOOT_AVA            ((uint32_t)0x00001000)  /* BOOT AVA flag */
#define FLASH_FLAG_BOOT_STATUS         ((uint32_t)0x00002000)  /* BOOT status flag */
#define FLASH_FLAG_OPTERR              ((uint32_t)0x80000001)  /* FLASH Option Byte error flag */
#define FLASH_FLAG_ENHANCE             ((uint32_t)0x40000040)  /* FLASH ENHANCE mode flag */
#define FLASH_FLAG_READY               ((uint32_t)0x40004000)  /* FLASH ready flag */
#define FLASH_FLAG_LPMODE              ((uint32_t)0x40008000)  /* FLASH low power mode flag */

/* FLASH_Access_CLK */
#define FLASH_CLK_HCLKDIV1             ((uint32_t)0x00000000)   /* FLASH Access Clock = HCLKClock */
#define FLASH_CLK_HCLKDIV2             ((uint32_t)0x00000001)   /* FLASH Access Clock = HCLKClock/2 */
#define FLASH_CLK_HCLKDIV4             ((uint32_t)0x00000002)   /* FLASH Access Clock = HCLKClock/4 */
#define FLASH_CLK_HCLKDIV8             ((uint32_t)0x00000003)   /* FLASH Access Clock = HCLKClock/8 */
...
FLASH_Status FLASH_UserOptionByteConfig(uint16_t OB_IWDG, uint16_t OB_RST, uint16_t OB_PowerON_Start_Mode,uint16_t OB_USBHSDL,uint16_t OB_USARTDL);
