...
*******************************************************************************/
#ifndef __CH32X3x5_USBPD_H
#define __CH32X3x5_USBPD_H
...
#define PIN_CC1                    GPIO_Pin_4
#define PIN_CC2                    GPIO_Pin_5
...
/******************************************************************************/
#define UPD_TMR_TX_240M    (400-1)                                             /* timer value for USB PD BMC transmittal @Fsys=48MHz */
#define UPD_TMR_RX_240M    (600-1)                                            /* timer value for USB PD BMC receiving @Fsys=48MHz */
