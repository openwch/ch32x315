...
{
    GPIO_InitTypeDef GPIO_InitStructure={0};
    GPIO_PinAFConfig(SoftUARTHardware.txPort, GPIO_PinSource6, GPIO_AF6);
    ...
    TIM_OC3Init(SoftUARTHardware.txTIM, &TIM_OCInitstructure);

    TIM_OC3PreloadConfig(SoftUARTHardware.txTIM, TIM_OCPreload_Disable);
    ...
    DMA_InitStruct.DMA_PeripheralBaseAddr = (u32)&SoftUARTHardware.txTIM->CH3CVR;
...
{
    // Configure the RCC used
    RCC_HB2PeriphClockCmd(RCC_HB2Periph_GPIOA | RCC_HB2Periph_TIM1 | RCC_HB2Periph_AFIO | RCC_HB2Periph_GPIOD, ENABLE);
    RCC_HB1PeriphClockCmd(RCC_HB1Periph_TIM2, ENABLE);
    RCC_HBPeriphClockCmd(RCC_HBPeriph_DMA1, ENABLE);
    ...
    SoftUARTHardware.txPort = GPIOA;
    SoftUARTHardware.txPin = GPIO_Pin_6;
