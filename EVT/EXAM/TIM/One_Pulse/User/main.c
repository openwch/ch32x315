 ...
 *@Note
 ...
 TIM2_CH1(PA4),TIM2_CH2(PA5)
 This routine demonstrates that in single-pulse mode, when a rising edge is detected
 on the TIM2_CH2(PA5) pin, the TIM2_CH1(PA4) outputs positive pulse.
...
void One_Pulse_Init( u16 arr, u16 psc, u16 ccp )
{
	...
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource5, GPIO_AF6);
...
int main(void)
{
	...
	printf("One_Pulse\r\n");	
	One_Pulse_Init( 1000-1, 24000-1, 500 );
	while (1);
}
