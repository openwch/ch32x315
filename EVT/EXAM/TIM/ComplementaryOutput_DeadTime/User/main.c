...
void TIM1_Dead_Time_Init( u16 arr, u16 psc, u16 ccp )
{
	...
	RCC_HB2PeriphClockCmd( RCC_HB2Periph_GPIOC|RCC_HB2Periph_GPIOD|RCC_HB2Periph_AFIO|RCC_HB2Periph_TIM1, ENABLE );

	GPIO_PinAFConfig(GPIOC, GPIO_PinSource4, GPIO_AF6);
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource13, GPIO_AF6);
