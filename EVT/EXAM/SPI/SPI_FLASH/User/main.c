 ...
 *@Note
 ...
 Master:SPI1_SCK(PA5);SPI1_MISO(PA7);SPI1_MOSI(PA6).
...
const u8 TEXT_Buf[] = {"CH32X315 SPI FLASH W25Qxx"};
...
void SPI_Flash_Init(void)
{
    ...
    RCC_HB2PeriphClockCmd(RCC_HB2Periph_AFIO | RCC_HB2Periph_GPIOB | RCC_HB2Periph_GPIOA, ENABLE);
