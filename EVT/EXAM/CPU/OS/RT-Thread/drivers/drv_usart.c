...
static struct ch32_uart_hw_config uart_hw_config[] =
{
#ifdef BSP_USING_UART1
    {
        /* clock configuration, please refer to ch32x3x5_rcc.h */
        RCC_HB2Periph_USART1, RCC_HB2Periph_GPIOA,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
        GPIOA, GPIO_Pin_11, /* Tx */GPIOA, GPIO_Pin_10, /* Rx */
        /* Whether to enable port remapping, you can refer to ch32x3x5_gpio.h file,
    ...
    {
        /* clock configuration, please refer to ch32x3x5_rcc.h */
        RCC_HB1Periph_USART2, RCC_HB2Periph_GPIOA,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
        GPIOA, GPIO_Pin_4, /* Tx */GPIOA, GPIO_Pin_5, /* Rx */
        /* Whether to enable port remapping, you can refer to ch32x3x5_gpio.h file,
        for example, USART1 needs to be turned on, you can use GPIO_Remap_USART1 */
        GPIO_Remap_NONE,
    },
    ...
    {
        /* clock configuration, please refer to ch32x3x5_rcc.h */
        RCC_HB1Periph_USART3, RCC_HB2Periph_GPIOA,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
    ...
    {
        /* clock configuration, please refer to ch32x3x5_rcc.h */
        RCC_HB1Periph_USART4, RCC_HB2Periph_GPIOA,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
        GPIOA, GPIO_Pin_8, /* Tx */GPIOA, GPIO_Pin_9, /* Rx */
        /* Whether to enable port remapping, you can refer to ch32x3x5_gpio.h file,
        for example, USART1 needs to be turned on, you can use GPIO_Remap_USART1 */
        GPIO_Remap_NONE,
    },
...
static rt_err_t ch32_configure(struct rt_serial_device *serial, struct serial_configure *cfg)
{
    ...
    {
        RCC_HB2PeriphClockCmd(uart->hw_config->uart_periph_clock, ENABLE);
...
#ifdef BSP_USING_UART1
#if defined (SOC_RISCV_SERIES_CH32X3)
