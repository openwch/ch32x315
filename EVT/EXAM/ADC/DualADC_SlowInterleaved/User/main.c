 ...
 *ADC1 channel 1 (PA3), ADC2 channel 1 (PB7), the rule group channel obtains
...
void  ADC_Function_Init(void)
{
	...
	ADC_InjectedChannelConfig(ADC2, ADC_Channel_1, 1);
	ADC_SetMode0SampleTimeConfig(ADC2, ADC_Channel_1,ADC_SampleTime_CyclesMode7);

    ADC_SoftwareStartConvCmd(ADC2, ENABLE);
    ADC_Cmd(ADC2, ENABLE);

    ADC_BufferCmd(ADC2, ENABLE);   //disable buffer
