 ...
 *@Note
 ...
 ADC channel 1 (PA3) - injection group channel, channel 3 (PA5) - injection group channel, channel 4 (PA6) - injection
...
void ADC_Function_Init(void)
{
	...
	ADC_SampleTimeModeConfig(ADC1, ADC_Channel_4, ADC_Sample_Time_Mode0);
	...
	ADC_InjectedChannelConfig(ADC1, ADC_Channel_4, 3);
	ADC_SetMode0SampleTimeConfig(ADC1, ADC_Channel_4,ADC_SampleTime_CyclesMode7);
