 ...
 *ADC channel 1 (PA3), detect that the ADC conversion data on the rule group channel
...
/* Global define */
#define ADC_Mode0_Sample 0
#define ADC_Mode1_Sample     1

/* ADC WWDG Mode Selection*/
// #define Sample_Mode  ADC_Mode0_Sample
#define Sample_Mode   ADC_Mode1_Sample
/* Global Variable */
...
{
    u16 val;
#if  (Sample_Mode == ADC_Mode0_Sample)
	ADC_SampleTimeModeConfig(ADC1, ch, ADC_Sample_Time_Mode0);
	ADC_RegularChannelConfig(ADC1, ch, 1);
	ADC_SetMode0SampleTimeConfig(ADC1, ch,ADC_SampleTime_CyclesMode7);
#else
	ADC_SampleTimeModeConfig(ADC1, ch, ADC_Sample_Time_Mode1);
	ADC_RegularChannelConfig(ADC1, ch, 1);
	ADC_SetMode1SampleTimeConfig(ADC1, 0x3f);
#endif
