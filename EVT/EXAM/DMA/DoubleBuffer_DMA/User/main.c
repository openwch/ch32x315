...
void TIM1_PWMOut_Init(u16 arr, u16 psc, u16 ccp)
{
    ...
    RCC_HB2PeriphClockCmd(RCC_HB2Periph_AFIO|RCC_HB2Periph_TIM1|RCC_HB2Periph_GPIOA, ENABLE);
...
void DMA_D_Buffer_Test_Mode1(void)
{
    ...
    TIM1_DMA_Init(DMA1_Channel5, (u32)TIM1_CH1CVR_ADDRESS, (u32)pbuf,(u32)pbuf1, Size);      
    TIM_Cmd(TIM1, ENABLE);
    TIM_CtrlPWMOutputs(TIM1, ENABLE);

    while((DMA1_Channel5->CFGR & (1<<16)) == RESET);
    DMA1_Channel5->MADDR = (u32)&bbuf[0];
    printf("Start RD2\r\n");
    for(t=0; t<Size; t++){
        printf("pbuf[%d]=%04x\r\n",t,pbuf[t]);
        printf("pbuf1[%d]=%04x\r\n",t,pbuf1[t]);
    ...
    while((DMA1_Channel5->CFGR & (1<<16)) != RESET);
    DMA1_Channel5->M1ADDR = (u32)&bbuf1[0];
    printf("Start RD3\r\n");
    for(t=0; t<Size; t++){
        printf("pbuf[%d]=%04x\r\n",t,pbuf[t]);
        printf("pbuf1[%d]=%04x\r\n",t,pbuf1[t]);
