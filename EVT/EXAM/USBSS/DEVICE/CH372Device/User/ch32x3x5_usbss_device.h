...
*******************************************************************************/
#ifndef __CH32X3x5_USBSS_DEVICE_H__
#define __CH32X3x5_USBSS_DEVICE_H__
...
#define DEF_ENDP1_OUT_BURST_LEVEL     8
#define DEF_ENDP1_IN_BURST_LEVEL      8
#define DEF_ENDP2_OUT_BURST_LEVEL     8
#define DEF_ENDP2_IN_BURST_LEVEL      8
#define DEF_ENDP3_OUT_BURST_LEVEL     8
#define DEF_ENDP3_IN_BURST_LEVEL      8
#define DEF_ENDP4_OUT_BURST_LEVEL     8
#define DEF_ENDP4_IN_BURST_LEVEL      8
...
#define USBSS_PHY_CFG_CR              (*((__IO uint32_t *)0x400381f8))
#define USBSS_PHY_CFG_DAT             (*((__IO uint32_t *)0x400381fc))
...
extern void USBSS_LINK_Handle( USBSSD_TypeDef *USBSSHx );
extern void SET_Device_Address( uint32_t address, USBSSD_TypeDef *USBSSx );
extern uint32_t USBSS_PHY_Cfg( uint8_t port_num, uint8_t addr, uint16_t data );
extern uint32_t USBSS_ReadPHYData( uint8_t port_num, uint8_t addr );
